...
#         # Images and Button
#         img_top = Image.open(r"C:\Users\jiyac\OneDrive\Pictures\Screenshots\Screenshot (18).png")
#         img_top = img_top.resize((650, 700), Image.Resampling.LANCZOS)
#         self.photoimg_top = ImageTk.PhotoImage(img_top)
#         f_lbl = Label(self.root, image=self.photoimg_top)
#         f_lbl.place(x=0, y=55, width=650, height=700)

#         img_bottom = Image.open(r"C:\Users\jiyac\OneDrive\Pictures\Screenshots\Screenshot (19).png")
#         img_bottom = img_bottom.resize((950, 700), Image.Resampling.LANCZOS)
#         self.photoimg_bottom = ImageTk.PhotoImage(img_bottom)
#         f_lbl = Label(self.root, image=self.photoimg_bottom)
#         f_lbl.place(x=650, y=55, width=950, height=700)

#         b1_1 = Button(f_lbl, text="Face Recognition", cursor="hand2", font=("times new roman", 19, "bold"), 
...
#                     conn = mysql.connector.connect(host="localhost", username="root", password="itsjiya@12345", database="facerecognition")
#                     cursor = conn.cursor()
#                     cursor.execute("SELECT name, Roll, Dep FROM student WHERE StudentId=%s", (id,))
...
#                         cv2.putText(img, f"Dept: {dep}", (x, y-5), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 3)
#                     else:
...
#         faceCascade = cv2.CascadeClassifier(r"C:\Users\jiyac\OneDrive\Documents\MINIPROJECT\COLLEGE_IMAGES\haarcascade_frontalface_default.xml")
#         clf = cv2.face.LBPHFaceRecognizer_create()
#         clf.read(r"C:\Users\jiyac\OneDrive\Documents\MINIPROJECT\classifier.xml")
...
#             draw_boundary(frame, faceCascade, 1.1, 10, (0, 255, 0), clf)
